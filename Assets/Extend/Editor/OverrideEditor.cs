...
{
    private readonly MethodInfo methodInfo = typeof (Editor).GetMethod("OnHeaderGUI",
        BindingFlags.NonPublic | BindingFlags.Instance);

    private Editor m_BaseEditor;

    protected Editor baseEditor => m_BaseEditor ? m_BaseEditor : (m_BaseEditor = GetBaseEditor());
