...
namespace Extend.UI.Editor {
	...
	public class UIViewLoopAnimationPropertyDrawer : PropertyDrawer {
		...
		private static readonly string[] stateTransformModeFieldNames = {"moveBy", "rotateBy", "scaleFrom", "fadeFrom"};
