...
cmake -DLUAC_COMPATIBLE_FORMAT=ON -DLUA_VERSION=5.4.3 -G "Visual Studio 17 2022" -A x64 ..
popd
...
cmake -DLUAC_COMPATIBLE_FORMAT=ON -DLUA_VERSION=5.4.3 -G "Visual Studio 17 2022" -A Win32 ..
popd
