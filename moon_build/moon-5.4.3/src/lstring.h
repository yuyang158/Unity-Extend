...
#define luaS_newliteral(L, s)	(moonS_newlstr(L, "" s, \
...
LUAI_FUNC unsigned int moonS_hash (const char *str, size_t l, unsigned int seed);
LUAI_FUNC unsigned int moonS_hashlongstr (TString *ts);
LUAI_FUNC int moonS_eqlngstr (TString *a, TString *b);
LUAI_FUNC void moonS_resize (lua_State *L, int newsize);
